    ...
    <!-- navbar -->
      <nav class="navbar navbar-expand-md navbar-dark" id="menu">
        <div class="container-fluid">
          <a class="navbar-brand " href="#" style="color: #FFF;"><img src="../../img/teste-logo.png" alt="logo" id="logo" >VivaVia Travel</a>
          ...
          <div class="offcanvas-lg offcanvas-end " tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
            <div class="offcanvas-header">
              <h5 class="offcanvas-title login " id="offcanvasResponsiveLabel">
                <ul class=" ">
                  <li class="nav-item">
                    <a class=" nav-link active" aria-current="page" href="../../pages/crud/cliente.html">Cliente</a></li>
                  <li class="nav-item">
                    <a class=" nav-link " href="#">Adm</a></li>
                </ul>
              </h5>
          ...
          <div class=" d-none d-lg-block  login">
              <ul class="">
                <li class="nav-item">
                  <a class=" nav-link active" aria-current="page" href="/pages/crud/cliente.html">Cliente</a>
                </li>
                <li class="nav-item">
...
<!-- formulÃ¡rio cliente -->
   ...
   <form action="./reserva-create" class="form-control d-grid gap-4 mx-auto p-3">
          <div>
              <h1 style="font-size: 1.3em; text-align: center;">Cadastrar reserva</h1>
          </div>
          <div class="">
              <label for="f-id-cliente">Cliente</label>
              <select type="number" class="form-control" id="f-id-cliente" name="id-cliente" required>
          ...
          <div class="">
              <label for="f-id-passagem">Passagem</label>
              <select type="number" class="form-control" id="f-id-passagem" name="id-passagem" required>
      ...
      <div class="row">
          ...
          <div class="col-6 col-md-8 mb-3 text-md-end">
              ...
              <li class="nav-item mb-2 col">
                <a href="em-construcao.html" class="nav-link p-0 ">Blog</a></li>
              <li class="nav-item mb-2 col">
                <a href="contato.html" class="nav-link p-0 ">Fale conosco</a></li>
              <li class="nav-item mb-2 col">
                <a href="em-construcao.html" class="nav-link p-0  ">PolÃ­tica de privacidade</a></li>
              <li class="nav-item mb-2 col">
                <a href="em-construcao.html" class="nav-link p-0  ">Termos & CondiÃ§Ãµes</a></li>
              </ul>
          </div>
