...
<!--	<jsp:include page="../../components/nav.jsp">
		<jsp:param name="logo" value="../../assets/img/teste-logo.png"/>
		<jsp:param name="home" value="../../index.jsp"/>
		<jsp:param name="hospedagens" value="hospedagens.html"/>
		<jsp:param name="passagens" value="passagens.html"/>
		<jsp:param name="destinos" value="destinos.html"/>
		<jsp:param name="promocoes" value="promocoes.html"/>
		<jsp:param name="contato" value="contato.html"/>
		<jsp:param name="btnCrud" value="cliente"/>
	</jsp:include>-->
  </header>
        ...
        <div class="row p-5">
            ...
            <div class="col-md-7 text-start">
                ...
                <p>
                    ...
                    Nossa equipe está a todo vapor, trabalhando para criar uma experiência incrível de viagens. <br>
                    Enquanto ajustamos cada detalhe, sinta-se à vontade para explorar nossas primeiras sugestões e compartilhar suas ideias conosco. 
                </p>
            </div>
        </div>
            
            <a href="index.html" class="btn btn-primary my-5 mx-auto">Ir para a página inicial</a>
    ...
    <footer class="py-5 px-3">
      <div class="row">
          ...
          <div class="col-6 col-md-8 mb-3 text-md-end">
              ...
              <li class="nav-item mb-2 col">
                <a href="em-construcao.html" class="nav-link p-0  ">Política de privacidade</a></li>
              <li class="nav-item mb-2 col">
                <a href="em-construcao.html" class="nav-link p-0  ">Termos & Condições</a></li>
              </ul>
          </div>
