...
/* 
      ...
      #carousel-principal .carousel-item:nth-child(1) {
        background-image: linear-gradient(rgba(0, 0, 0, 0.35),rgba(0, 0, 0, 0.25)), url(assets/img/carousel/desktop-1.jpg);
      }

      #carousel-principal .carousel-item:nth-child(2) {
        background-image: linear-gradient(rgba(0, 0, 0, 0.35),rgba(0, 0, 0, 0.25)), url(assets/img/carousel/desktop-2.jpg);
      }

      #carousel-principal .carousel-item:nth-child(3) {
        background-image: linear-gradient(rgba(0, 0, 0, 0.35),rgba(0, 0, 0, 0.25)), url(assets/img/carousel/desktop-3.jpg);
      }
    ...
    <header class="row" >
      ...
      <nav class="navbar navbar-expand-md navbar-dark" id="menu">
        <div class="container-fluid">
          <a class="navbar-brand " href="#" style="color: #FFF;"><img src="assets/img/teste-logo.png" alt="logo" id="logo" >VivaVia Travel</a>
          <!-- botao menu telas pequenas -->

          <button class="btn d-lg-none navbar-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive" id="offcanvas-btn">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="offcanvas-lg offcanvas-end " tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
            <div class="offcanvas-header ">
              <h5 class="offcanvas-title login " id="offcanvasResponsiveLabel">
		            <jsp:include page="./components/btnCrud.jsp">
            ...
            <!-- <div class=" "> -->
              ...
              <ul class="navbar-nav offcanvas-body off col-lg-8">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="views/_pages/hospedagens.html">Hospedagens</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="views/_pages/passagens.html">Passagens</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="views/_pages/destinos.html">Destinos</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="views/_pages/promocoes.html">Promoções</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="views/_pages/contato.html">Contato</a>
                </li>
              </ul>
            <!-- </div> -->
          </div>
           ...
           <div class=" d-none d-lg-block  login">
             <!--  <ul class="">
                <li class="nav-item">
                  <a class="btn nav-link " href="views/clienteCrud/index.jsp">Crud</a>
                </li>
              </ul>
               -->
        ...
        <div id="carousel-principal" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div id="" class="container-fluid py-3 my-3 mx-auto">
        <div id="top-destinos" >
          <div>
            ...
            <p class=" display-4">Lugares mais procurados do Brasil essa semana.</p>
          </div>
            ...
            <div class="card-group gap-3">
              ...
              <div class="card text-bg-dark">
                <img src="assets/img/cidades/porto-seguro-ba.jpg" class="card-img" alt="...">
                <div class="card-img-overlay">
      ...
      <div class="d-block">
        ...
        <section id="hospedagens" class="container-fluid py-3 my-3 mx-auto">
          ...
          <div>
            ...
            <p class="display-4">Milhares de hotéis para você encontrar o perfeito pras suas férias.</p>
          </div>
          
          <div class=" ">
            <div class="d-flex flex-nowrap justify-content-between overflow-x-scroll  ">
              <div class="card ">
                <img src="assets/img/hoteis/hotel-4.jpg" class="img-fluid rounded-start" alt="...">
                <div class="card-body">
              ...
              <div class="card">
                <img src="assets/img/hoteis/hotel-6.jpg" class="img-fluid rounded-start" alt="...">
                <div class="card-body">
                  <h5 class="card-title">NomeHotel</h5>
                  <div class="pb-3">
              ...
              <div class="card">
                <img src="assets/img/hoteis/hotel-3.jpg" class="img-fluid rounded-start" alt="...">
                <div class="card-body">
                  <h5 class="card-title">NomeHotel</h5>
                  <div class="pb-3">
            ...
            <div class="">
              <div class="card " >
                ...
                <div class="card-body">
                  ...
                  <p><i class="bi bi-airplane"></i> Saindo de Sâo Paulo </p>
                  <p><i class="bi bi-airplane"></i> Para Porto Seguro</p>
                </div>
                <div class="card-footer">
                  <p>Preço a partir de <strong>R$ 380</strong></p>
                  <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                </div>
              </div>
            </div>
            <div class="">
              <div class="card " >
                ...
                <div class="card-body">
                  ...
                  <p><i class="bi bi-airplane"></i> Saindo de São Paulo </p>
                  <p><i class="bi bi-airplane"></i> Para Fortaleza</p>
                </div>
                <div class="card-footer">
                  <p>Preço a partir de <strong>R$ 560</strong></p>
                  <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                </div>
              </div>
              </div>
              <div class="">
                <div class="card " >
                  ...
                  <div class="card-footer">
                    <p>Preço a partir de <strong>R$ 350</strong></p>
                    <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                  </div>
                </div>
              </div>
              <div class="">
                <div class="card " >
                  ...
                  <div class="card-footer">
                    <p>Preço a partir de <strong>R$ 430</strong></p>
                    <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                  </div>
                </div>
              </div>
            ...
            <div class="">
              <div class="card " >
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Breve descrição do hotel.</p>
                  <p>Preço a partir de <strong>R$ 1.230</strong></p>
                  <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                </div>
            </div>
            </div>
            <div class="">
              <div class="card " >
                ...
                <div class="card-body">
                  ...
                  <p><i class="bi bi-building"></i> Hotel nomeHotel</p>
                  <p class="card-text">Breve descrição do hotel.</p>
                  <p>Preço a partir de <strong>R$ 1540</strong></p>
                  <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                </div>
            </div>
            </div>
            <div class="">
              <div class="card " >
                ...
                <div class="card-body">
                  ...
                  <p><i class="bi bi-building"></i> Hotel nomeHotel</p>
                  <p class="card-text">Breve descrição do hotel.</p>
                  <p>Preço a partir de <strong>R$ 970</strong></p>
                  <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                </div>
              </div>
            </div>
            <div class="">
              <div class="card " >
                ...
                <div class="card-body">
                  ...
                  <p><i class="bi bi-building"></i> Hotel nomeHotel</p>
                  <p class="card-text">Breve descrição do hotel.</p>
                  <p>Preço a partir de <strong>R$ 1640</strong></p>
                  <a href="em-construcao.html" class=" btn btn-primary d-block">Ver detalhes</a>
                </div>
              </div>
            </div>
